package org.example.session02.bai2.controllers;

import org.example.session02.bai2.models.Student;
...
// ReportController.java (Controller gửi dữ liệu — đúng, không sửa)
@Controller
